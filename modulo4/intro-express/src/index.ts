...
const posts: Post[] = [
    ...
    },
    {
        ...
        body: "Na nova escola, On precisa aprender a lidar com os valentões. Joyce abre um pacote misterioso. Em Hawkins, uma jogadora atrevida agita a noite da D&D."
    },
